        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          >
            <img
              ...
              src="https://nova-plumbing.s3.us-east-2.amazonaws.com/DALL%C2%B7E+2025-01-17+16.19.12+-+A+minimalist+image+of+the+state+of+Utah+in+a+simple+white+color%2C+with+no+background+(transparent+background).+The+shape+should+be+accurate+to+Utah's+g.webp"
              alt="State of Utah"
            />
            <div class="w-full flex-auto">
              ...
              <p class="mt-6 text-pretty text-lg/8 text-gray-300">
                We are a Utah based company. If you need service anywhere in Utah give us a call.
...
const benefits = ['Utah County', 'Salt Lake County']
</script>
